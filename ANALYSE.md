...
├── enhanced_config.py      # API keys, model settings
...
├── enhanced_system.py      # Orchestrator: train / predict / analyze
...
```bash
# Stap 1: Vul je API keys in enhanced_config.py

# Stap 2: Train het model
python main.py enhanced --mode train --league E0 --start-year 2018

# Stap 3: Analyseer een competitie
python main.py enhanced --mode analyze --league N1

# Stap 4: Voorspel wedstrijden
python main.py enhanced --mode predict --league T1 --fixtures-file fixtures.json
```
